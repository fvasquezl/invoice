...
<div class="modern-minimalist bg-white p-12" style="min-height: 297mm;">
    ...
    <div class="mb-12">
        <h3 class="text-sm font-bold uppercase tracking-wide mb-3" style="color: {{ $primaryColor }};">
            Bill To
        </h3>
    ...
    <div class="mb-12">
        <table class="w-full">
            <thead>
                <tr class="border-2" style="border-color: {{ $primaryColor }};">
            ...
            <tbody>
                @foreach ($invoice->items as $item)
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-4 text-right text-g text-gray-600">${{ number_format($item->unit_price, 2) }}
                        </td>
                        <td class="py-4 text-right text-g text-gray-800">${{ number_format($item->total, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="space-y-6">
        @if ($invoice->notes)
            <div>
                <h4 class="text-sm font-bold uppercase tracking-wide mb-2" style="color: {{ $primaryColor }};">Notes
                </h4>
        ...
        @if ($invoice->terms)
            <div>
                <h4 class="text-sm font-bold uppercase tracking-wide mb-2" style="color: {{ $primaryColor }};">Payment
                    Terms
                </h4>
